...
// DEBUG: Uncomment baris di bawah untuk melihat session data
...
// Cek role dengan berbagai kemungkinan
$current_role = '';
if (isset($_SESSION['role'])) {
    $current_role = strtolower(trim($_SESSION['role']));
}

// DEBUG: Uncomment untuk melihat role yang terdeteksi
// echo "<pre>Current Role: '$current_role'</pre>"; die();

// Redirect jika bukan kasir
if ($current_role !== 'kasir') {
...
$current_user = $_SESSION['username'] ?? 'Kasir';

// =====================================================
// STATISTIK DASHBOARD KASIR
// =====================================================
...
// 3. Pendapatan Hari Ini (KASIR TIDAK BISA LIHAT NOMINAL)
// Data tetap di-query tapi tidak ditampilkan ke kasir
...
<div class="container-fluid">
    ...
    <div class="row g-3 mb-4">
        ...
        <!-- Pendapatan Hari Ini - KASIR TIDAK BISA LIHAT -->
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold text-warning">Rp 0K</h2>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted small">Transaksi hari ini akan muncul di sini</p>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <a href="../menu/index.php" class="btn btn-outline-success">
                            <i class="bi bi-list-ul"></i> Lihat Menu
                        </a>
                        <a href="../meja/index.php" class="btn btn-outline-info">
                            <i class="bi bi-grid-3x3"></i> Status Meja
                        </a>
