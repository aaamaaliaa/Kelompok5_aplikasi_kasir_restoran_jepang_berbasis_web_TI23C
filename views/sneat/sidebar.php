...
if ($userRole === 'admin') {
    $menuItems = [
        ...
        [
            'label' => 'Pengaturan',
            'icon' => 'bx-cog',
            'url' => base_url('settings/index.php'),
            'badge' => null
        ]
    ];
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="<?= base_url() ?>" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Resto Jepang</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <?php foreach ($menuItems as $item): ?>
            ...
            <li class="menu-item <?= $isActive ? 'active' : '' ?>">
                <a href="<?= htmlspecialchars($item['url']) ?>" class="menu-link">
                    <i class="menu-icon tf-icons bx <?= htmlspecialchars($item['icon']) ?>"></i>
                    <div data-i18n="<?= htmlspecialchars($item['label']) ?>"><?= htmlspecialchars($item['label']) ?></div>
                    <?php if ($item['badge']): ?>
                        <div class="badge bg-danger rounded-pill ms-auto"><?= htmlspecialchars($item['badge']) ?></div>
                    <?php endif; ?>
                </a>
            </li>
        <?php endforeach; ?>
        ...
        <!-- Logout -->
        <li class="menu-item">
            <a href="<?= base_url('logout.php') ?>" class="menu-link" onclick="return confirm('Yakin ingin keluar?')">
